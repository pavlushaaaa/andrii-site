...
export const services = [
  ...
  { n: '04', small: 'Лекції та воркшопи', title: 'Для людей, які зібрали інших людей.', body: ['Для команд, компаній, шкіл, конференцій та інших місць, де збираються люди й слухають інших людей.', 'Можу прийти з лекцією, воркшопом, Q&A або корпоративним навчанням.'], cta: 'Запросити ↗' },
